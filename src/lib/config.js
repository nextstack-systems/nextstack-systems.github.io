...
export const SERVICES = [
  {
    ...
    short: 'A polished, fast, SEO-ready website that makes your business look established and turns visitors into enquiries.',
    deliverables: [
      ...
      '1 domain + hosting + 1 professional email (1 year)',
  ...
  },
  {
    ...
    featured: true,
    short: 'A full e-commerce experience — product listings, orders, and revenue, wired into your CRM from day one.',
    deliverables: [
      'Website design & development — WordPress / PHP / Next.js',
  ...
  },
  {
    ...
    price: 10000,
    priceLabel: 'from ₹10,000',
    short: 'Put every conversation on your website subdomain with a full WhatsApp CRM — shared inbox, pipelines, broadcasts and AI replies.',
    deliverables: [
      'WhatsApp CRM on your website subdomain',
      'Meta Business profile + WhatsApp API creation & integration',
      '1 year VPS hosting (renews at ₹5,000/year)',
      'Shared inbox — assign threads, reply as a team, internal notes',
      'Contact hub — tags, custom fields, notes, CSV import, auto dedup',
  ...
  },
  {
    ...
    price: 10000,
    priceLabel: 'from ₹10,000',
    short: 'Email, SMS & push marketing set up end-to-end so every campaign lands in the inbox and converts.',
    deliverables: [
  ...
  },
  {
    ...
    price: 10000,
    priceLabel: 'from ₹10,000',
    short: 'Conversion-optimised funnels for services and products — landing pages, upsells, and automated nurturing.',
    deliverables: [
  ...
  },
  {
    ...
    price: 20000,
    priceLabel: 'from ₹20,000',
    short: 'Automate the busywork — lead capture, data sync, chatbots and reports that run themselves with n8n.',
    deliverables: [
...
export const PROCESS_STEPS = [
  {
    ...
    items: ['Free 30-min intro call', 'Requirements mapping', 'Scope & timeline estimate'],
  },
  {
    step: '02',
    ...
    items: ['Sitemap & wireframes', 'Tech stack selection', 'Fixed-price proposal'],
  },
  {
    step: '03',
    title: 'Design & Build',
    duration: 'Weeks 1–3',
    description:
      'Modern, on-brand design followed by clean, fast, SEO-friendly development. You get a staging link to review as we go.',
    items: ['UI/UX design', 'Development & integrations', 'Weekly progress updates'],
  },
  {
    step: '04',
    ...
    items: ['Quality assurance', 'Speed & security audit', 'Domain + email setup'],
  },
  {
    step: '05',
    ...
    items: ['30 days free support', 'Maintenance options', 'Analytics & reporting'],
  },
]
...
export const INDUSTRIES = [
  {
    ...
    icon: 'store',
    description: 'Restaurants, retail, gyms, salons, travel — get online and get booked.',
    items: [
  ...
  },
  {
    group: 'Professionals',
    icon: 'briefcase',
    description: 'Trust-building websites that turn searches into booked consultations.',
    items: [
  ...
  },
  {
    ...
    icon: 'building',
    description: 'Scalable web systems for teams that need to look bigger and sell faster.',
    items: [
